...
my %in_dist = (0 => 4, 1 => 3, 2 => 2, 3 => 1);
my %out_dist = (4 => 1, 3 => 2, 2 => 3, 1 => 4);
my %rooms;
@{$rooms{hallway}} = ('.') x 11;
while (my $line = <>) {
    chomp $line;
...
splice @{$rooms{A}}, 1, 0, qw/D D/;
splice @{$rooms{B}}, 1, 0, qw/C B/;
splice @{$rooms{C}}, 1, 0, qw/B A/;
splice @{$rooms{D}}, 1, 0, qw/A C/;
